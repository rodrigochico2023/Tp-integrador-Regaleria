                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="navbar-nav ml-auto justify-content-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="IniciarSecion.html">INGRESAR</a>
                            </li>
        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="Termo.jpg" class="d-block w-100" alt="b">
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$14600</h5>
                        <p class="card-text text-center fuente-descripcion">Las Oreiro. Cartera simil cuero, de excelente calidad</p>
                        <a href="#" class="btn button fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Cartera Las Oreiro - marrón', 14600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$15200</h5>
                        <p class="card-text text-center fuente-descripcion">Las Oreiro. Mochila simil cuero, de excelente calidad</p>
                        <a href="#" class="btn button fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Mochila - Las Oreiro marrón', 15200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
        </div>
