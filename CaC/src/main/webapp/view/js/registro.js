...
function validarUser() {
    ...
    // Obtengo lo que ingresó el usuario en el input
    let user = document.getElementById("user").value;
    console.log(`user= ${user}`);

    if (!user.includes("@")) {
        // El usuario debe contener un @
        document.getElementById("mensaje").innerHTML = "El usuario debe contener un @";
        document.getElementById("mensaje").className = "cartel-adv m-1 p-1 border rounded";
    } else {
        document.getElementById("mensaje").innerHTML = "";
        document.getElementById("mensaje").className = "";
    }
...
function mostrarFortCant() {
    ...
    if (pass.length<=4) {
        ...
        document.getElementById("mensaje").className="cartel-adv  m-1 p-1 border rounded text-center "        
...
function mostrarPass() {
    ...
    document.getElementById("icono").setAttribute("class", "bi bi-eye-fill custom-icon")
    document.getElementById("icono").setAttribute("onclick","ocultarPass()")
}

function ocultarPass() {
    document.getElementById("pass").setAttribute("type","password")
    document.getElementById("icono").setAttribute("class", "bi bi-eye-slash-fill custom-icon")
    document.getElementById("icono").setAttribute("onclick","mostrarPass()")
}

//todo: verificar que las pass sean iguales

// Funciones para validar los nuevos campos
function validarNombre() {
    let nombre = document.getElementById("nombre").value;
    let mensajeElement = document.getElementById("mensaje");

    // Puedes agregar la lógica de validación para el nombre aquí
}
...
function validarApellido() {
    ...
    // Puedes agregar la lógica de validación para el apellido aquí
}
...
function validarDNI() {
    ...
    // Puedes agregar la lógica de validación para el DNI aquí
}
...
function validarTelefono() {
    ...
    // Puedes agregar la lógica de validación para el teléfono aquí
}
...
function validarDireccion() {
    ...
    // Puedes agregar la lógica de validación para la dirección aquí
}