 ...
 <div class="row mt-5 cortes">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fuente back-nav">
                    ...
                    <div class="col-12">
                        <ul class="navbar-nav ml-auto justify-content-center">
                        	...
                        	<li class="nav-item">
                            	...
                            	<span> <% out.print(na); %> <img alt="" src="<% out.print(foto); %>" class="img-fluid rounded-4 md-3 m-3 " width="40px"> </span>
                            
                        	</li>
                        	
                            <li class="nav-item md-3 m-3">
	                            <a class="nav-link" href="../index.html"><samp class="log-out ">Cerrar sesión</samp></a>
	                        </li>
                            <a class=" md-3 m-3" href="#" onclick="mostrarCarrito()">
                                <img src="../imagenes/shopping-cart.png" width="25" alt="carrito">
                            </a>
                        </ul>
                    </div>
                </div>
        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../imagenes/Termo.jpg" class="d-block w-100" alt="b">
                    <div class="carousel-caption d-md-block">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-8 text-center text-lg-end">
                                ...
                                <p> El termo y mate que estabas buscando está acá 
                                </p>
                                <div class="lg-4">
                                    <a href="index.html#Termos" class="btn btn-outline-light">Ver más</a>
                                    <a href="#" class="btn buttonn fuente fs-6" onclick="agregarAlCarritoYMostrar('Combo ST', 20000)">Comprar</a>
                                </div>
                            </div>
                ...
                <div class="carousel-item">
                    <img src="../imagenes/cartera.jpeg" class="d-block w-100 " alt="...">
                    <div class="carousel-caption text-center text-lg-end d-md-block">
                        ...
                        <div class="lg-4">
                            <a href="index.html#Carteras" class="btn btn-outline-light">Ver más</a>
                ...
                <div class="carousel-item">
                    <img src="../imagenes/Relojes.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption text-center text-lg-end d-md-block">
                        <h5 class="fs-3">Regalá</h5>
                        <p>Miles de modelos para todo el mundo, encontrá acá los mejores reloes para regalar y regalarte.
                        </p>
                        <a href="index.html#Relojes" class="btn btn-outline-light">Ver más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Termo mates de 500cc, ideal para compartir esos momentos especiales. Excelente calidad y precio</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Termo mate 500', 8300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Termos de 600cc colores varios, ideal para regalar o regalarse. Excelente calidad y precio</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Termo 600cc', 13700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Pava electrica, marca Caliente de 1000cc. Con encendido electronico. Excelente calidad y precio </p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Pava electrica 1000cc', 14600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Termo deportista de 500cc. Marca Fit, conserva la temperatura. Excelente calidad</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Termo deportista 500cc', 17200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Juego cubierto asador', 8300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Juego matero', 23700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Juego asador', 24600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Producto 4', 5200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="carritoModal" class="modal ">
        <div class="modal-content fuente-modal">
            ...
            <p class="fuente-custom">Total: $<span id="total">0</span></p>
                <p >Cantidad de productos: <span id="cantidadProductos">0</span></p>
                <p>Descuento aplicado: <span id="descuentoAplicado">0%</span></p>
                <p class="fuente-custom1">Descuento efectuado: <span id="descuentoEnPesos">$0</span></p>    
            
            <button class="btn buttonn fuente fs-6" onclick="ocultarCarrito()">Cerrar Carrito</button>
        </div>
    </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj red and black', 22500)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Reloj, con detalles en fibra de carbono, de altisima calidad y excelente precio</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj red and black', 33700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj - Sin Markas', 28300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj - Switch', 28300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$23700</h5>
                        <p class="card-text text-center fuente-descripcion">Reloj Swicht - Excelente calidad con diamantes incrustados y pilas incluidas</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj - Switch', 23700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$24600</h5>
                        <p class="card-text text-center fuente-descripcion">Reloj, con detalles en fibra de carbono, de altisima calidad y excelente precio</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj black and red', 24600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-center fuente-descripcion">Reloj, con detalles en fibra de carbono, de altisima calidad y excelente precio</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Reloj black and red', 25200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Bolso de mano - Tortolitas', 18300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Mochila - Tortolitas', 13700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Cartera mano -  Amayra de tela', 14600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Mochila - Amayra de tela', 15200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Cartera Las Oreiro - Charol negra', 18300)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Mochila - Las Oreiro negra', 13700)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$14600</h5>
                        <p class="card-text text-center fuente-descripcion">Las Oreiro. Cartera simil cuero, de excelente calidad</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Cartera Las Oreiro - marrón', 14600)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center fuente-precio fw-bold">$15200</h5>
                        <p class="card-text text-center fuente-descripcion">Las Oreiro. Mochila simil cuero, de excelente calidad</p>
                        <a href="#" class="btn buttonn fuente fs-6 d-block mx-auto" onclick="agregarAlCarritoYMostrar('Mochila - Las Oreiro marrón', 15200)">Agregar al carrito</a>
                    </div>
                </div>
            </div>
        </div>
